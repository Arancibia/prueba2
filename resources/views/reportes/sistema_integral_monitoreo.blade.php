...
@include('alerts.errors')
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
             <font size="4" color="red">Sistema Integral De Monitoreo</font>          
        </div>
        ...
        <div class="col-lg-1 col-md-1 col-sm-1 col-xs-12" align="left">
            <button class="btn-sm btn-info" title="BUSCAR" onclick="Buscar_Sistema_Integral_Monitoreo()"><i class="fa fa-search"></i></button> 
            <button class="btn-sm btn-success" title="PDF" id="btn_pdf"><i class="fa fa-file-text" aria-hidden="true"></i></button> 
        </div>                                      
